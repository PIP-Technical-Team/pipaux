...
```{r setup-fake-root, include=FALSE}
# Create a fake root structure inside tempdir
fake_root <- file.path(tempdir(), "root")
dir.create(file.path(fake_root, "pip_ingestion_pipeline"), recursive = TRUE, showWarnings = FALSE)

# Override '/' by changing the working directory
old_wd <- setwd(fake_root)

# When knitting finishes, reset the working dir
