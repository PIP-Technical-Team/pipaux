...
pip_cp_update <- function(force = FALSE, maindir = getOption("pipaux.maindir")) {
  ...
  key_indicators <- merge(dl$KI1, dl$KI5_KI6_KI7, all = TRUE,
  ...
  ki4 <- dl$chart6_KI4[, c('country_code', 'year_range',
  ...
  charts <- list(
    ...
    mpm =
      dl$chart5[, c('country_code', 'reporting_year',
                    'welfare_type',
    ...
    sp =
      dl$chart6_KI4[, c('country_code', 'year_range',
